...
stargazer(mrating_df, title= "Box Office Sales per Rating (USD Millions)", type='text',
...
stargazer(mrating_df, title= "Number of Movies per Rating", type='text',
          no.space=TRUE,
         summary=FALSE)
```
...
stargazer(genre_rating_top_5, title= "Number of Movies per Movie and Rating", type='text',
          no.space=TRUE,
          column.sep.width = "3pt",
          column.labels = c("Genre","Rating", "Movies"),
          rownames = NULL,
          summary=FALSE)
```
