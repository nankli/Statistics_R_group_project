...
#out <-boxplot.stats(post_2000_filtered$clean_box_office_real)$out
#out_ind <- which(post_2000_filtered$clean_box_office_real %in% c(out))
#out_ind

p6 <- post_2000_filtered  %>%
...
post_2000_filtered <- post_2000_filtered %>%
  filter(clean_box_office_real < 2000 & clean_budget_real <350)

p1_1 <- post_2000_filtered %>%
...
post_2000_filtered <- post_2000_filtered %>%
  filter(clean_box_office_real < 2000 & clean_budget_real <350)
p3_1 <- post_2000_filtered %>%
  ggplot() + aes(x=clean_budget_real) + geom_histogram(position ='dodge', bins=30) + labs(title = 'Distribution of budget', x = 'Budget (Million $)', y = 'Frequency')

p4_1 <- post_2000_filtered %>%
  ggplot() + aes(x=log(clean_budget_real + 1)) + geom_histogram(position ='dodge', bins=30) + labs(title = 'Distribution of log(Budget)', x = 'log(Budget) (Million $)', y = 'Frequency')
p3_1|p4_1
