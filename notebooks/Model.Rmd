...
post_2000_filtered <- post_2000 %>%
  #remove extreme outliers as a result of EDA, remove values between 0 and 1
  filter(clean_box_office_real < 2000 & clean_box_office_real >= 1.0 & clean_budget_real >=1.0 & clean_budget_real <350)
post_2000_filtered <- post_2000_filtered %>% 
  mutate(
...
model_1 = lm(data=post_2000_filtered, box_office_log ~ budget_log)
model_2 = lm(data=post_2000_filtered, box_office_log ~ budget_log + duration_minutes +
               maturity_rating + genre_primary)
model_3 = lm(data=post_2000_filtered, box_office_log ~ budget_log + duration_minutes +
...
model_4 = lm(data=post_2000_filtered, box_office_log ~ budget_log + duration_minutes +
